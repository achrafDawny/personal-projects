...
package object functions {
  ...
  def rddToRDDActivity(input: RDD[ConsumerRecord[String, String]]) = {
  ...
  def mapActivityStateFunc = (key: (String, Long), value: Option[ActivityByProduct], state: State[(Long, Long, Long)]) => {
